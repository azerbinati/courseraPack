...
Travis Build: [![Build Status](https://travis-ci.org/azerbinati/courseraPack.svg?branch=master)](https://travis-ci.org/azerbinati/courseraPack)
Appveyor Build: [![Build status](https://ci.appveyor.com/api/projects/status/e0wg31kupkbmy2tn?svg=true)](https://ci.appveyor.com/project/azerbinati/courserapack)
